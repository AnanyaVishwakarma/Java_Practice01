/*Alice and Bob have a different total number of candies. You are given two integer arrays aliceSizes and bobSizes where aliceSizes[i] is the number of candies of the ith box of candy that Alice has and 
...
in the box that Bob must exchange. If there are multiple answers, you may return any one of them. 
...
//SumA - x+y = SumB - y + x where x is aliceCandyBox y is bobs Candybox
    ...
    public static void main(String[] args){
        int[] result1 = fairCandySwap(new int[] {1, 1}, new int[] {2, 2});
